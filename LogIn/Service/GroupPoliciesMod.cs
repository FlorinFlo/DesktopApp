...
namespace LogIn.Service
{
    ...
    class GroupPoliciesMod :Attribute
    {
        ...
        public abstract class GroupPolicyObject
        {
            ...
            {
                //System.Windows.Forms.MessageBox.Show("Assembly.."+assembly);
              //  System.Windows.Forms.MessageBox.Show(Assembly.GetExecutingAssembly() + "Assembly");
                
                object[] attributes = assembly.GetCustomAttributes(typeof(T), true);
               // System.Windows.Forms.MessageBox.Show("Assemblyxws12" + (attributes).Count());
                if (attributes.Length == 0)
                {
                    return null;
                }

                //System.Windows.Forms.MessageBox.Show("Assemblyxws" + (T)attributes[0]);
            ...
            {
                //System.Windows.Forms.MessageBox.Show("Instance????????????????");
                var concrete = new GPClass();
               // System.Windows.Forms.MessageBox.Show("Instance3" + concrete);
              //  System.Windows.Forms.MessageBox.Show("Instance5" + (IGroupPolicyObject)concrete);
